                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <div class="col-md-12 card card-outline card-primary demo-login">
                                   <div class="card-body">
                                      <div class="text-bold">Admin</div>
                                            <small> admin@gmail.com | 123456</small>
                                      <div class="text-bold mt-3">Branch</div>
                                            <small> orlando@yopmail.com | 123456</small>
                                   </div>
                                </div>
                            </div>
                        </div>
