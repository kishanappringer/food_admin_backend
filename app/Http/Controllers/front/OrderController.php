...
class OrderController extends Controller
{
    ...
    public function index() {
        ...
        return view('front.orders',compact('orderdata','getabout','getdata','branch','getinfo'));
    }
    ...
    public function orderdetails(Request $request) {
        ...
        $getdata=User::select('currency')->where('type','1')->first();
        $getinfo = About::select('logo','footer_logo','favicon','fb','twitter','insta','android','ios','title','short_title','og_image','og_title','og_description','copyright')->where('id','1')->first();
        return view('front.order-details',compact('orderdata','summery','getabout','getdata','branch','getinfo'));
    }
    ...
    public function cashondelivery(Request $request)
    {
        ...
        $getdata=User::select('token','firebase','min_order_amount','max_order_amount','currency')->where('type','1')
        ->get()->first();
